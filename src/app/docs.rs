...
use crate::{
    ...
    automations::dto::{
        ...
        AutomationStatus, AutomationStepKind, PublishAutomationRequest, TestRunAutomationRequest,
        TestRunAutomationResponse, UpdateAutomationStatusRequest, WorkflowActionType,
        WorkflowConnectionPayload, WorkflowPayload, WorkflowStepPayload,
    },
    error::ErrorResponse,
